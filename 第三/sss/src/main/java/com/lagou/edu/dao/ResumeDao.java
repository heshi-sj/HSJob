...
public interface ResumeDao extends JpaRepository<Resume,Long>, JpaSpecificationExecutor<Resume> {
     ...
     * @return
     */
    @Query(value = "select * from tb_resume  where username like ?1 and address like ?2",nativeQuery = true)
    ...
    @Delete(value = "delect * from tb_resume  where id like ?1 ")
    public  void delect(Map<String, String> id);
    @Insert(value = "insert into tb_resume  (id,usrname,adress,phone) VALUES (?1,?2,?3,?4) ")
    public void add(Map<String, String> map);
    @Update(value = "update tb_resume set username =? and address= ?  where id like ?1 ")
